...
namespace JKApi.Data.DAL
{
    ...
    public partial class SalesPersonBonusCommissionSchedule
    {
        public int SalesPersonBonusCommissionScheduleId { get; set; }
        public Nullable<int> CommissionAdditionalBonusScheduleId { get; set; }
        public Nullable<int> SalesPersonId { get; set; }
        public Nullable<int> BonusAmountTypeId { get; set; }
