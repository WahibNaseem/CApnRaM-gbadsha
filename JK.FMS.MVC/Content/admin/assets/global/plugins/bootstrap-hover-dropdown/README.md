...
```html
<li class="dropdown">
    <a href="JavaScript:Void(0)" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="false">
        Account <b class="caret"></b>
    </a>
    <ul class="dropdown-menu">
        <li><a tabindex="-1" JavaScript:Void(0)>My Account</a></li>
        <li class="divider"></li>
        <li><a tabindex="-1" JavaScript:Void(0)>Change Email</a></li>
        <li><a tabindex="-1" JavaScript:Void(0)>Change Password</a></li>
        <li class="divider"></li>
        <li><a tabindex="-1" JavaScript:Void(0)>Logout</a></li>
    </ul>
</li>
```
