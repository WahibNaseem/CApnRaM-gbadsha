	...
	var Mapplic = function() {
		...
		var processData = function(data) {
			...
			if (nrlevels > 1) {
				...
				var up = $('<a JavaScript:Void(0)></a>').addClass('mapplic-levels-up').appendTo(self.levels);
				self.levelselect.appendTo(self.levels);
				var down = $('<a JavaScript:Void(0)></a>').addClass('mapplic-levels-down').appendTo(self.levels);
