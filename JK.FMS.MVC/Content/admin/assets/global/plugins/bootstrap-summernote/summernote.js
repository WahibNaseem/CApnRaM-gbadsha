...
(function (factory) {
  ...
  var LinkDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var footer = '<buttonhref="JavaScript:Void(0)"class="btn btn-primary note-link-btn disabled" disabled>' + lang.link.insert + '</button>';
  ...
  var ImageDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = '<div class="form-group note-group-select-from-files">' +
                 ...
                 '</div>';
      var footer = '<buttonhref="JavaScript:Void(0)"class="btn btn-primary note-image-btn disabled" disabled>' + lang.image.insert + '</button>';
  ...
  var VideoDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = '<div class="form-group row-fluid">' +
          ...
          '</div>';
      var footer = '<buttonhref="JavaScript:Void(0)"class="btn btn-primary note-video-btn disabled" disabled>' + lang.video.insert + '</button>';
