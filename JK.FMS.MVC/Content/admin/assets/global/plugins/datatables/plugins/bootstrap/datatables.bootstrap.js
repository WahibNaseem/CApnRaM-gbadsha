...
$.extend($.fn.dataTableExt.oPagination, {
    "bootstrap_full_number": {
        "fnInit": function (oSettings, nPaging, fnDraw) {
            ...
            $(nPaging).append(
                '<ul class="pagination">' +
                '<li class="prev disabled"><a href="JavaScript:Void(0)" title="' + oLang.sFirst + '"><i class="fa fa-angle-double-left"></i></a></li>' +
                '<li class="prev disabled"><a href="JavaScript:Void(0)" title="' + oLang.sPrevious + '"><i class="fa fa-angle-left"></i></a></li>' +
                '<li class="next disabled"><a href="JavaScript:Void(0)" title="' + oLang.sNext + '"><i class="fa fa-angle-right"></i></a></li>' +
                '<li class="next disabled"><a href="JavaScript:Void(0)" title="' + oLang.sLast + '"><i class="fa fa-angle-double-right"></i></a></li>' +
                '</ul>'
            );
            var els = $('a', nPaging);
            $(els[0]).bind('click.DT', {
        ...
        "fnUpdate": function (oSettings, fnDraw) {
            ...
            for (i = 0, iLen = an.length; i < iLen; i++) {
                ...
                for (j = iStart; j <= iEnd; j++) {
                    ...
                    $('<li ' + sClass + '><a JavaScript:Void(0)>' + j + '</a></li>')
    ...
    "bootstrap_extended": {
        "fnInit": function (oSettings, nPaging, fnDraw) {
            ...
            $(nPaging).append(
                ...
                '<a href="JavaScript:Void(0)" class="btn btn-sm default prev disabled"><i class="fa fa-angle-left"></i></a>' +
                ...
                '<a href="JavaScript:Void(0)" class="btn btn-sm default next disabled"><i class="fa fa-angle-right"></i></a> ' +
